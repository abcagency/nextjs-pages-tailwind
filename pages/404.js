...
const NotFoundPage = ({ router }) => {
	return (
		<Layout>
			<PageHead location={router} title="404: Not found" />
			...
			<div className="bg-pink-200 text-center px-3 py-5">
				<div className="container">
					<h2 className="text-gray-800 text-xl font-bold">
						Looks like this page is a ghost that got abducted{' '}
						<span className="whitespace-nowrap">by aliens...</span>
					</h2>
					...
					>
						<Icon icon="mdi:home" size="w-6 h-6" className="inline-block" />
						Head home
					</Link>
				</div>
