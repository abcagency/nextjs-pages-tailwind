...
const Home = () => {
	return (
		<Layout>
			...
			<Jumbotron className="bg-transparent! text-gray-850!">
			...
			<Section id="alpha" className="container px-4 my-12">
				...
				<p>
					...
					<Button.Anchor href="/" type="link" variant="primary" hasUnderline>
						Placeat dolor inventore deserunt, perferendis asperiores quibusdam
						repudiandae <Button.Icon icon="fa-brands:instagram" />
					</Button.Anchor>
