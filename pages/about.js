...
const AboutPage = () => {
	return (
		<Layout>
			...
			<Section id="accordion" className="container px-4 my-12">
			...
			<Section id="card" className="container px-4 my-12">
			...
			<Section id="video-player" className="container px-4 my-12">
